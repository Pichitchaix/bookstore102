...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-400 via-amber-400 to-orange-400 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="appearance-none block w-full pl-10 pr-3 py-3 border border-gray-300
                    ...
                    focus:ring-yellow-300 focus:border-yellow-300 transition-colors"
            ...
            <button
              ...
              className="w-full flex justify-center py-3 px-4 border border-transparent
                rounded-xl shadow-sm text-sm font-medium text-white bg-yellow-600
                hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2
                focus:ring-yellow-500 transition-colors duration-200"
            >
              เข้าสู่ระบบ
            </button>
          </form>
        ...
        <div className="text-center">
          <Link to="/" className="text-sm text-white hover:text-yellow-100 transition-colors">
            ← กลับสู่หน้าแรก
          </Link>
        </div>
      </div>
